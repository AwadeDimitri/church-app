  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        path: 'bible',
        loadComponent: () =>
          import('./features/bible/feature/bible-list/bible-list'),
      },
      {
        path: 'bible/:bookSlug',
        loadComponent: () =>
          import('./features/bible/feature/bible-book/bible-book'),
      },
      {
        path: 'bible/:bookSlug/:chapter',
        loadComponent: () =>
          import('./features/bible/feature/bible-chapter/bible-chapter'),
      },
      {
        path: 'prayer',
